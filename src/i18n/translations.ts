...
const en: Translations = {
  chapters: [
    ...
    { title: 'THE PHOTON SPHERE', subtitle: 'Light orbits here. Trapped by gravity, it circles endlessly. A prison with no walls.' },
  ...
  credits: {
    ...
    roles: [
      ...
      { role: 'Built with', name: 'TypeScript · Three.js · GLSL · GSAP' },
      { role: 'Editor', name: 'VS Code · Vite' },
    ],
...
const fr: Translations = {
  chapters: [
    ...
    { title: 'LA SPHÈRE DE PHOTONS', subtitle: 'La lumière tourne en rond ici. Prisonnière de la gravité, elle ne s\'échappe plus.' },
  ...
  credits: {
    ...
    roles: [
      ...
      { role: 'Construit avec', name: 'TypeScript · Three.js · GLSL · GSAP' },
      { role: '\u00C9diteur', name: 'VS Code · Vite' },
    ],
