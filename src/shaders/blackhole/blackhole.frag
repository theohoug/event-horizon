...
void main() {
  ...
  vec3 camPos = vec3(
    sin(scrollEffect * 0.4) * 0.3 + sin(uTime * 0.03) * 0.02 + mouseParallax.x * mix(0.4, 0.1, scrollEffect),
    mix(7.0, 0.06, scrollEffect * (0.8 + 0.2 * scrollEffect)) + sin(uTime * 0.08) * 0.03 + mouseParallax.y * mix(0.25, 0.05, scrollEffect),
